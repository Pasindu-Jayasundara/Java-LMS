...
-- Dumping data for table java_lms.exam_type: ~0 rows (approximately)
...
-- Dumping data for table java_lms.notice: ~0 rows (approximately)
...
-- Dumping data for table java_lms.status: ~2 rows (approximately)
